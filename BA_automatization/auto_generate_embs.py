...
def start_emb_train(triple_path, inverse, Model,
    ...
    for i in range(1,100):
        ...
        if i>1 and (losses[-2] - losses[-1]) < 1e-7: # changed to 1e-9for DisMult Only! 1e-6 to 1e-7
...
triple_path = '/sc-projects/sc-proj-ukb-cvd/data/2_datasets_pre/220208_graphembeddings/triples/triple_list_filtered_graph_full_v3.feather'
#triple_path= '/home/tilingl/Pykeen/Triple_Lists/less_001_relations.feather'
